...
#define IMG_PIXEL(img,x,y) (((img[(y)][(x)/8])&(1<<((x)%8)))) //摄像头数据解压语句
...
//LED
#define LED2_PORT PORTA,26
#define LED1_PORT PORTA,27
//#define LED3_PORT PORTA,19
#define LED2 PTA26_OUT
#define LED1 PTA27_OUT
//#define LED3 PTA19_OUT

#define LED2_ON        PTA26_OUT = 0
#define LED1_ON        PTA27_OUT = 0
//#define LED3_ON        PTA19_OUT = 0
#define LED2_OFF       PTA26_OUT = 1
#define LED1_OFF       PTA27_OUT = 1
